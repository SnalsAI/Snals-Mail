...
class SlotGeneratorService:
    ...
    def _genera_slots_per_disponibilita(
        ...
        for competenza in competenze:
            ...
            # Calcola durata con priorità:
            # 1. durata_slot_minuti dalla disponibilità (override per questo giorno specifico)
            # 2. durata_minuti dalla competenza staff
            # 3. durata_default_minuti dal tipo appuntamento
            if disponibilita.durata_slot_minuti:
                durata_minuti = disponibilita.durata_slot_minuti
            elif competenza.durata_minuti:
                durata_minuti = competenza.durata_minuti
            else:
                durata_minuti = tipo.durata_default_minuti
